...
const { getState: getCORSState } = require("../../living/helpers/cors-settings");
...
module.exports = class ResourceLoader {
  ...
  _getRequestOptions(urlString, { cookieJar, referrer, accept = "*/*", element }) {
    ...
    if (cookieJar && (!crossOrigin || mode === "no-cors" || credentialsMode === "include")) {
  ...
  fetch(urlString, options = {}) {
    ...
    switch (url.scheme) {
      ...
      case "http":
      case "https": {
        const requestOptions = this._getRequestOptions(urlString, options);
