...
module.exports = class ResourceLoader {
  ...
  _getRequestOptions(urlString, { cookieJar, referrer, accept = "*/*", element }) {
    ...
    const crossOriginAttr = element && element.crossOrigin && element.crossOrigin.toLowerCase();
    ...
    if (crossOriginAttr === "" || crossOriginAttr === "anonymous" || crossOriginAttr !== "use-credentials") {
      credentialsMode = "same-origin";
    }

    if (cookieJar && (!crossOrigin || credentialsMode === "include")) {
