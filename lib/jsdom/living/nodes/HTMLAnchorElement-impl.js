...
class HTMLAnchorElementImpl extends HTMLElementImpl {
  ...
  // An anchor element has an activation behavior only if it creates a hyperlink.
  // An anchor element represents a hyperlink if it has an href attribute.
  get _hasActivationBehavior() {
    return this.hasAttributeNS(null, "href");
  }
